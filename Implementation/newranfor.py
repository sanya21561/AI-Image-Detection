...
rf_classifier.fit(X_train.reshape(-1, 32*32*3), y_train)
print("Model Trained")

# Make predictions on the validation data
val_predictions = rf_classifier.predict(X_val.reshape(-1, 32*32*3))
...
y_prob = rf_classifier.predict_proba(X_val.reshape(-1, 32*32*3))
...
test_predictions = rf_classifier.predict(test_data.reshape(-1, 32*32*3))
...
test_y_prob = rf_classifier.predict_proba(test_data.reshape(-1, 32*32*3))
